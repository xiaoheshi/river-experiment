 ...
 * 锦标赛中单一策略的累计表现。
 */
public final class StrategyPerformance implements Comparable<StrategyPerformance> {
    ...
    public StrategyPerformance(CooperationStrategy strategy,
                               double totalScore,
                               int matches,
    ...
    @Override
    public int compareTo(StrategyPerformance other) {
